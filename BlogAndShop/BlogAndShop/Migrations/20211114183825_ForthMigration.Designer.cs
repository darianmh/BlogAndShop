...
namespace BlogAndShop.Migrations
{
    ...
    [Migration("20211114183825_ForthMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlogAndShop.Data.ViewModel.Product.BrandModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BlogAndShop.Data.Data.Product.Product", b =>
                {
                    ...
                    b.HasOne("BlogAndShop.Data.ViewModel.Product.BrandModel", "Brand")
                        .WithMany("Products")
                        .HasForeignKey("BrandId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("BlogAndShop.Data.Data.Product.Brand", null)
                        .WithMany("Products")
