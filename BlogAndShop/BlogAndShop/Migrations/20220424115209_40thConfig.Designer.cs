...
namespace BlogAndShop.Migrations
{
    ...
    [Migration("20220424115209_40thConfig")]
    partial class _40thConfig
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlogAndShop.Data.Data.Product.DownloadItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("DownloadPathId");

                    b.ToTable("DownloadItem");
                });
            ...
            modelBuilder.Entity("BlogAndShop.Data.Data.Product.DownloadItem", b =>
                {
                    ...
                    b.HasOne("BlogAndShop.Data.Data.Common.Media", "DownloadPath")
                        .WithMany("DownloadItems1")
                        .HasForeignKey("DownloadPathId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BannerImage");

                    b.Navigation("DownloadPath");
                });
