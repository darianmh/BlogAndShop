...
//{
//    [AdminFilterName(AdminControllerNames.User, "نقش های کاربر")]
...
//            var model = new AdminListViewModel<UserRoles>(hasNext: all.TotalCount > page * count, hasPre: page > 1, items: all.List, page: page, count: all.List.Count, pagesCount: ((all.TotalCount - 1) / count) + 1);
//            return View(model);
//        }
...
//        [HttpPost]
//        public async Task<IActionResult> Create(UserRolesModel model)
//        {
...
//        }
//        [HttpPost]
//        public async Task<IActionResult> Edit(UserRolesModel model)
//        {
//            var item = model.ToEntity();
...
//        public UserRolesController(IUserRolesService service) : base()
//        {
//            _service = service;
//        }
//        #endregion
